...
local LEADERBOARD_LAYOUT = {
    ...
    replayTimestampOffsetY = 0,
    defaultTimestampOffsetY = 2,
    replayDotOffsetX = 5,
    replayDotOffsetY = 18,
    replayDotRadius = 3,
    replayLabelOffsetX = 14,
    replayLabelOffsetY = 10,
    rowBottomPadding = 56,
...
local LEVEL_SELECT_LEADERBOARD_CARD = {
    ...
    rowPaddingX = 10,
    rankWidth = 32,
    replayIndicatorRankGap = 5,
    replayIndicatorDiameter = 10,
    replayIndicatorRadius = 5,
    replayIndicatorNameGap = 4,
    scoreWidth = 76,
    pinnedGap = 12,
    statusPaddingX = 20,
...
local shared = {
    ...
    NETWORK_REQUEST_OVERLAY = NETWORK_REQUEST_OVERLAY,
