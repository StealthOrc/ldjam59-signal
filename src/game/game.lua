...
local function buildTuning()
    return {
        ...
        plantedRearGripLowSpeed = 32,
        plantedRearGripHighSpeed = 18,
        gripSpeedWindow = 360,
        handbrakeGripMultiplier = 0.26,
        handbrakeDrag = 22,
        driftSteerThreshold = 0.98,
        driftHandbrakeSteerThreshold = 0.35,
        driftMinSpeedKmh = 35,
        driftRecoverSteerThreshold = 0.45,
        driftRecoverSlipThreshold = 12,
        driftRecoverAngularVelocity = math.rad(18),
